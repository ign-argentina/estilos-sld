...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="1.1.0" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:se="http://www.opengis.net/se" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:ogc="http://www.opengis.net/ogc">
  <NamedLayer>
    <se:Name>ne_10m_bathymetry_e_6000</se:Name>
    <UserStyle>
      <se:Name>batimetria_6000_capa_base</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>Batimetría 6000</se:Name>
          <se:Description>
            <se:Title>Batimetría 6000</se:Title>
          </se:Description>
          <se:PolygonSymbolizer>
            <se:Fill>
              <se:SvgParameter name="fill">#9bd2ff</se:SvgParameter>
            </se:Fill>
            <se:Stroke>
              <se:SvgParameter name="stroke">#9bd2ff</se:SvgParameter>
