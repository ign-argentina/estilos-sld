              ...
              <!-- Provincias z5 sin CABA ni T.del Fuego-->
                <se:Rule>
                    ...
                    <se:TextSymbolizer>
                        ...
                        <se:Fill>
                            <se:SvgParameter name="fill">#7d7880</se:SvgParameter> <!-- 7d7880 -->
              ...
              <!-- Provincias z6 sin CABA ni T.del Fuego -->
                ...
                <se:Rule>
                    ...
                    <se:TextSymbolizer>
                        ...
                        <se:Fill>
                            <se:SvgParameter name="fill">#7d7880</se:SvgParameter>
                        </se:Fill>
              ...
              <!-- Tierra del Fuego z5-->
                <se:Rule>
                    ...
                    <se:TextSymbolizer>
                        ...
                        <se:Halo>
                            <se:Radius>0.45</se:Radius>
                            <se:Fill>
                                <se:SvgParameter name="fill">#FFFFFF</se:SvgParameter>
                            </se:Fill>
                        </se:Halo>
                        <se:Fill>
                            <se:SvgParameter name="fill">#706c73</se:SvgParameter>
                        </se:Fill>
                        <se:VendorOption name="maxDisplacement">1</se:VendorOption>
                        <se:VendorOption name="autoWrap">100</se:VendorOption>
                        <se:VendorOption name="charSpacing">0.2</se:VendorOption>
