...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:xlink="http://www.w3.org/1999/xlink" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" version="1.1.0" xmlns:ogc="http://www.opengis.net/ogc" xmlns:se="http://www.opengis.net/se" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  <NamedLayer>
    <se:Name>desinventar_biologico_riesgo</se:Name>
    <UserStyle>
      <se:Name>desinventar_biologico_riesgo</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>desinventar_biologico_riesgo_mb</se:Name>
          <se:Description>
       ...
       <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>desinventar_biologico_riesgo_b</se:Name>
          <se:Description>
          ...
          <se:PolygonSymbolizer>
            <se:Fill>
              <se:SvgParameter name="fill">#ccece6</se:SvgParameter>
              <se:SvgParameter name="fill-opacity">0.8</se:SvgParameter>
            </se:Fill>
            <se:Stroke>
              <se:SvgParameter name="stroke">#a8a8a8</se:SvgParameter>
       ...
       <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>desinventar_biologico_riesgo_m</se:Name>
          <se:Description>
       ...
       <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>desinventar_biologico_riesgo_a</se:Name>
          <se:Description>
       ...
       <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>desinventar_biologico_riesgo_ma</se:Name>
          <se:Description>
