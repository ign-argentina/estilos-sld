          ...
          <se:PointSymbolizer>
            <se:Graphic>
              ...
              <se:Mark>
                ...
                <se:Fill>
                  <se:SvgParameter name="fill">#92262B</se:SvgParameter>
                </se:Fill>
                <!--<se:Stroke>
            ...
            <se:Graphic>
              <se:Mark>
                ...
                <se:Fill>
                  ...
                  <se:Stroke>
                  <se:SvgParameter name="stroke">#92262B</se:SvgParameter>
        ...
        <se:Rule>
          ...
          <se:PointSymbolizer>
            <se:Graphic>
              ...
              <se:Mark>
                <se:WellKnownName>file://edificio_educativo_12.svg.svg</se:WellKnownName>
                <se:Fill>
        ...
        <se:Rule>
          ...
          <se:PointSymbolizer>
            <se:Graphic>
              ...
              <se:Mark>
                <se:WellKnownName>file://universidad_.svg.svg</se:WellKnownName>
                <se:Fill>
                  <se:SvgParameter name="fill">#a58c67</se:SvgParameter>
                </se:Fill>
                <se:Stroke>
        ...
        <se:Rule>
          ...
          <se:PointSymbolizer>
            <se:Graphic>
              ...
              <se:Mark>
                <se:WellKnownName>file://universidad_.svg</se:WellKnownName>
                <se:Fill>
                  <se:SvgParameter name="fill">#a58c67</se:SvgParameter>
                </se:Fill>
                <se:Stroke>
