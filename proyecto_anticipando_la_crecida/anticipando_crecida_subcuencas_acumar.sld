...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" version="1.1.0" 
    ...
    <NamedLayer>
        <se:Name>cuencas_anticipando_la_crecida</se:Name>
        <UserStyle>
            <se:Name>cuencas_anticipando_la_crecida</se:Name>
            <se:FeatureTypeStyle>
                <se:Rule>
                    <se:Name>cuencas_anticipando_la_crecida</se:Name>
                    <se:Description>
                        <se:Title>cuencas_anticipando_la_crecida</se:Title>
                    </se:Description>
                                                            <se:PolygonSymbolizer>
                        <se:Fill>
                            <se:SvgParameter name="fill">#e1f2fa</se:SvgParameter>
                            <se:SvgParameter name="fill-opacity">0.2</se:SvgParameter>
                        </se:Fill>
                        <se:Stroke>
                            <se:SvgParameter name="stroke">#72828a</se:SvgParameter>
