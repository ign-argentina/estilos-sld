...
<se:MinScaleDenominator>9000001</se:MinScaleDenominator>
 ...
 <se:PointSymbolizer>
            <se:Graphic>
              <!--Parametric SVG-->
              <se:ExternalGraphic>
                <se:OnlineResource xlink:type="simple" xlink:href="http://172.20.205.70/geoserver/styles/bahra/paraje.svg?fill=%23ffffff&amp;fill-opacity=1&amp;outline=%23000000&amp;outline-opacity=1&amp;outline-width=0"/>
                <se:Format>image/svg+xml</se:Format>
              </se:ExternalGraphic>
              <!--Plain SVG fallback, no parameters-->
              <se:ExternalGraphic>
                <se:OnlineResource xlink:type="simple" xlink:href="http://172.20.205.70/geoserver/styles/bahra/paraje.svg"/>
                <se:Format>image/svg+xml</se:Format>
              </se:ExternalGraphic>
