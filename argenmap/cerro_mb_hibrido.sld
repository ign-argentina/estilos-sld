              ...
              <!-- Etiquetas Cerros principales-->
                <se:Rule>
                    ...
                    <se:TextSymbolizer>
                        ...
                        <se:Fill>
                            <se:SvgParameter name="fill">#d9cece</se:SvgParameter>
                        </se:Fill>
               ...
               <!-- Etiquetas cerros z11 - 273k-->
                <se:Rule>
                    ...
                    <se:TextSymbolizer>
                      ...
                      <se:VendorOption name="autoWrap">50</se:VendorOption>
                      <se:VendorOption name="spaceAround">200</se:VendorOption>
               ...
               <!-- Etiquetas cerros z12 - 136k-->
                <se:Rule>
                    ...
                    <se:MinScaleDenominator>100000</se:MinScaleDenominator>
                    <se:MaxScaleDenominator>180000</se:MaxScaleDenominator>
                    <se:TextSymbolizer>
                        <se:Label>
                            <ogc:PropertyName>fna</ogc:PropertyName>
                        </se:Label>
                        ...
                        <se:Halo>
                            <se:Radius>1</se:Radius>
                            <se:Fill>
                                <se:SvgParameter name="fill">#140303</se:SvgParameter>
                            </se:Fill>
                        </se:Halo>
                        <se:Fill>
                            <se:SvgParameter name="fill">#d9cece</se:SvgParameter>
