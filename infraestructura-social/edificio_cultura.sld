      ...
      <se:FeatureTypeStyle>
          ...
          <se:PointSymbolizer>
            <se:Graphic>
              <se:Mark>
                ...
                <se:Fill>
                  <se:SvgParameter name="fill">#945A36</se:SvgParameter> 
            ...
            <se:Graphic>
              <se:Mark>
                ...
                <se:Fill>
                  ...
                  <se:Stroke>
                  <se:SvgParameter name="stroke">#945A36</se:SvgParameter>
        ...
        <se:Rule>
          ...
          <se:PointSymbolizer>
            <se:Graphic>
              <se:ExternalGraphic>
                <se:OnlineResource xlink:href="edificio_cultura.svg" xlink:type="simple"/>
