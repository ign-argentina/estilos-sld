...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" 
    ...
    <NamedLayer>
        <se:Name>areas_de_glaciologia_capa_base</se:Name>
        <UserStyle>
            <se:Name>areas_de_glaciologia_capa_base</se:Name>
            <se:FeatureTypeStyle>
                <se:Rule>
                    ...
                    <se:PolygonSymbolizer>
                        <se:Fill>
                            <se:SvgParameter name="fill">#c6e8f5</se:SvgParameter>
                            <se:SvgParameter name="fill-opacity">0.3</se:SvgParameter>
                        </se:Fill>
                        <se:Stroke>
                            <se:SvgParameter name="stroke">#20b9f5</se:SvgParameter>
                            ...
                            <se:GraphicFill>
                                <se:Graphic>
                                    ...
                                    <se:Mark>
                                        ...
                                        <se:Fill>
                                            <se:SvgParameter name="fill">#6ed4bc</se:SvgParameter>
                                        </se:Fill>
                                        <se:Stroke>
