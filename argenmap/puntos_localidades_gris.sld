                    ...
                    <se:PointSymbolizer>
                        <se:Graphic>
                            <se:Mark>
                                ...
                                <se:Fill>
                                    <se:SvgParameter name="fill">#999898</se:SvgParameter>
                                </se:Fill>
                                <se:Stroke>
                                    <se:SvgParameter name="stroke">#999898</se:SvgParameter>
           ...
           <!--Etiquetas capitales provinicales z7-->
            <se:FeatureTypeStyle>
               ...
               <!--Etiquetas capitales provinciales corrientes z8-->
                ...
                <!--Etiquetas capitales provinciales SMT z7-->
                ...
                <se:Rule>
                    <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
                      ...
                      <ogc:PropertyIsEqualTo>
                        ...
                        <ogc:PropertyIsEqualTo>
                            <ogc:PropertyName>fna</ogc:PropertyName> <!-- zoom 7-->
                            <ogc:Literal>San Miguel de Tucumán</ogc:Literal>
                        </ogc:PropertyIsEqualTo>
                        </ogc:And>
                    </ogc:Filter>
                    <se:MinScaleDenominator>3000000</se:MinScaleDenominator>
