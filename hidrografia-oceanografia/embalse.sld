...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:se="http://www.opengis.net/se" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1.0" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:ogc="http://www.opengis.net/ogc">
  <NamedLayer>
    <se:Name>areas_de_aguas_continentalesS</se:Name>
    <UserStyle>
      <se:Name>areas_de_aguas_continentales</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>embalse</se:Name>
          <se:PolygonSymbolizer>
            <se:Fill>
              <se:SvgParameter name="fill">#1608f2</se:SvgParameter>
              <se:SvgParameter name="fill-opacity">0.23</se:SvgParameter>
            </se:Fill>
            <se:Stroke>
              <se:SvgParameter name="stroke">#1608f2</se:SvgParameter>
