        ...
        <se:Rule>
          ...
          <se:TextSymbolizer>
            ...
            <se:Halo>
              ...
              <se:Fill>
                <se:SvgParameter name="fill">#d3fbf3</se:SvgParameter> <!--d3fbf3 -->
        ...
        <se:Rule>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:Or>
              ...
              <ogc:PropertyIsEqualTo>
                <ogc:PropertyName>nombre_geografico</ogc:PropertyName>
                <ogc:Literal>Golfo San JosÃ©</ogc:Literal>
              </ogc:PropertyIsEqualTo>
              <ogc:PropertyIsEqualTo>
                <ogc:PropertyName>nombre_geografico</ogc:PropertyName>
              ...
              <ogc:PropertyIsEqualTo>
                <ogc:PropertyName>nombre_geografico</ogc:PropertyName>
                <ogc:Literal>Bahía San JuliÃ¡n</ogc:Literal>
              </ogc:PropertyIsEqualTo>
              <ogc:PropertyIsEqualTo>
                <ogc:PropertyName>nombre_geografico</ogc:PropertyName>
          ...
          <se:TextSymbolizer>
            ...
            <se:Fill>
              <se:SvgParameter name="fill">#373787</se:SvgParameter> <!-- 373787-->
            </se:Fill>
