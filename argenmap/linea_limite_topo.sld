        ...
        <UserStyle>
                ...
                <se:Rule>
                  ...
                  <se:LineSymbolizer>
                        <se:Stroke>
                            ...
                            <se:SvgParameter name="stroke-width">.75</se:SvgParameter>
            ...
            <se:FeatureTypeStyle>
                <se:Rule>
                    ...
                    <se:LineSymbolizer>
                        <se:Stroke>
                            <se:SvgParameter name="stroke">#5b5b5b</se:SvgParameter>
                            <se:SvgParameter name="stroke-width">0.05</se:SvgParameter>
            ...
            <se:FeatureTypeStyle>
                <se:Rule>
                    ...
                    <se:LineSymbolizer>
                        <se:Stroke>
                            <se:SvgParameter name="stroke">#69418f</se:SvgParameter>
                            <se:SvgParameter name="stroke-opacity">0.6</se:SvgParameter>
