...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:se="http://www.opengis.net/se" xmlns:ogc="http://www.opengis.net/ogc" version="1.1.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xlink="http://www.w3.org/1999/xlink" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd">
  <NamedLayer>
    <se:Name>estación_ferrocarril_gl</se:Name>
    <UserStyle>
      <se:Name>estación_ferrocarril_gl</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          ...
          <se:PointSymbolizer>
            <se:Graphic>
              <se:Mark>
                ...
                <se:Fill>
                  <se:SvgParameter name="fill">#5484A9</se:SvgParameter>
            ...
            <se:Graphic>
              <se:Mark>
                ...
                <se:Fill>
                  ...
                  <se:Stroke>
                  <se:SvgParameter name="stroke">#5484A9</se:SvgParameter>
        ...
        <se:Rule>
          ...
          <se:PointSymbolizer>
            <se:Graphic>
              <se:ExternalGraphic>
                <se:OnlineResource xlink:type="simple" xlink:href="estacion_de_ferrocarril.svg"/>
