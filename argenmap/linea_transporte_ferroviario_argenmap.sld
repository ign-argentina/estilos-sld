    ...
    <UserStyle>
      ...
      <se:FeatureTypeStyle>
        <se:Rule>
          ...
          <se:LineSymbolizer>
            <se:Stroke>
              <se:SvgParameter name="stroke">#b0b0b0</se:SvgParameter> <!-- b0b0b0-->
        ...
        <!--Línea ferroviaria abandonada etiquetas-->
        <se:Rule>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>fun</ogc:PropertyName>
          ...
          <se:TextSymbolizer>
            <se:Label>
              <ogc:Function name="Concatenate">
                ...
                <ogc:Literal> - (abandonado)</ogc:Literal>
              </ogc:Function>
            </se:Label>
            <se:Font>
            ...
            <se:Fill>
              <se:SvgParameter name="fill">#292626</se:SvgParameter>
            </se:Fill>
      ...
      <se:FeatureTypeStyle>
        <se:Rule>
          ...
          <se:LineSymbolizer>
            <se:Stroke>
              <se:SvgParameter name="stroke">#595353</se:SvgParameter>
        ...
        <!--Línea ferroviaria desde nivel 12 -->
        <se:Rule>
          <se:Name>Línea ferroviario</se:Name>
          <se:Description>
            <se:Title>Línea ferroviario</se:Title>
