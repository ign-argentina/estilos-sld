...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:se="http://www.opengis.net/se" version="1.1.0" xmlns:xlink="http://www.w3.org/1999/xlink" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  <NamedLayer>
    <se:Name>red_ramsac_idera</se:Name>
    <UserStyle>
      <se:Name>red_ramsac_idera</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>ramsac</se:Name>
          <se:Description>
            <se:Title>ramsac</se:Title>
          </se:Description>
          ...
          <se:PointSymbolizer>
            <se:Graphic>
              <se:Mark>
                ...
                <se:Fill>
                  <se:SvgParameter name="fill">#3F51B5</se:SvgParameter>
                </se:Fill>
              </se:Mark>
              <se:Size>2</se:Size>
            </se:Graphic>
        ...
        <se:Rule>
          ...
          <se:PointSymbolizer>
            <se:Graphic>
              ...
              <se:ExternalGraphic xmlns="http://www.opengis.net/sld" xmlns:xlink="http://www.w3.org/1999/xlink">
                <se:OnlineResource xlink:type="simple" xlink:href="red_ramsac.svg" />
          ...
          <se:TextSymbolizer>
            <se:Label>
              <ogc:PropertyName>cer</ogc:PropertyName>
            </se:Label>
            <se:Font>
