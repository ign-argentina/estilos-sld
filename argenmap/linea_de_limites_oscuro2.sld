        ...
        <UserStyle>
            ...
            <se:FeatureTypeStyle>
                <se:Rule>
                    ...
                    <se:LineSymbolizer>
                        <se:Stroke>
                  <se:SvgParameter name="stroke">#0C0C0C</se:SvgParameter>
            ...
            <se:FeatureTypeStyle>
                <se:Rule>
                    ...
                    <se:LineSymbolizer>
                        <se:Stroke>
                            <se:SvgParameter name="stroke">#F9F7F3</se:SvgParameter>
                    ...
                    <se:LineSymbolizer>
                        <se:Stroke>
                            <se:SvgParameter name="stroke">#8F8E8B</se:SvgParameter>
                            <se:SvgParameter name="stroke-width">0.65</se:SvgParameter>
                            <se:SvgParameter name="stroke-linejoin">round</se:SvgParameter>
                            <se:SvgParameter name="stroke-linecap">round</se:SvgParameter>
            ...
            <se:FeatureTypeStyle>
                <se:Rule>
                    ...
                    <se:LineSymbolizer>
                        <se:Stroke>
                            <se:SvgParameter name="stroke">#464645</se:SvgParameter>
                            <se:SvgParameter name="stroke-width">0.5</se:SvgParameter>
                            <se:SvgParameter name="stroke-linejoin">bevel</se:SvgParameter>
                            <se:SvgParameter name="stroke-linecap">round</se:SvgParameter>
                        </se:Stroke>
