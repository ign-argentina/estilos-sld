...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:xlink="http://www.w3.org/1999/xlink" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" version="1.1.0" xmlns:ogc="http://www.opengis.net/ogc" xmlns:se="http://www.opengis.net/se" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  <NamedLayer>
    <se:Name>indice_de_vulnerabilidad_social_frente_a_desastres_sintesis_riesgo</se:Name>
    <UserStyle>
      <se:Name>indice_de_vulnerabilidad_social_frente_a_desastres_sintesis_riesgo</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>cortes_naturales_ivsd_mb</se:Name>
          <se:Description>
            <se:Title>Muy bajo (cortes naturales IVSD)</se:Title>
          </se:Description>
       ...
       <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>cortes_naturales_ivsd_b</se:Name>
          <se:Description>
            <se:Title>Bajo (cortes naturales IVSD)</se:Title>
          </se:Description>
           <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>categoria</ogc:PropertyName>
       ...
       <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>cortes_naturales_ivsd_m</se:Name>
          <se:Description>
            <se:Title>Medio (cortes naturales IVSD)</se:Title>
          </se:Description>
           <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>categoria</ogc:PropertyName>
       ...
       <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>cortes_naturales_ivsd_a</se:Name>
          <se:Description>
            <se:Title>Alto (cortes naturales IVSD)</se:Title>
          </se:Description>
           <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>categoria</ogc:PropertyName>
       ...
       <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>cortes_naturales_ivsd_ma</se:Name>
          <se:Description>
            <se:Title>Muy alto (cortes naturales IVSD)</se:Title>
          </se:Description>
           <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>categoria</ogc:PropertyName>
