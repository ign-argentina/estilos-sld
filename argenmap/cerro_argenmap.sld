                ...
                <se:Rule>
                    ...
                    <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
                        <ogc:Or>
                            ...
                            <!-- Mas altos por provincia - Comentados por nombres repetidos o
                            inexistentes en BDGI-->
...
<ogc:Literal>Cerro Vallecitos</ogc:Literal>
                    ...
                    <se:PointSymbolizer>
                        <se:Graphic>
                            <se:ExternalGraphic>
                                <se:OnlineResource xlink:href="cerro_capa_base.svg"
                                    xlink:type="simple" />
                ...
                <se:Rule>
                    ...
                    <se:MinScaleDenominator>273001</se:MinScaleDenominator> <!--10-->
                    <se:MaxScaleDenominator>4000000</se:MaxScaleDenominator> <!--8-->
                    <se:TextSymbolizer>
                        <se:Label>
                            <ogc:PropertyName>fna</ogc:PropertyName>
                        </se:Label>
...
<ogc:Literal>Cerro Tres Picos</ogc:Literal>
                ...
                <ogc:Literal>Cerro Vallecitos</ogc:Literal>
                    ...
                    <se:MinScaleDenominator>100000</se:MinScaleDenominator><!--12-->
...
<ogc:Literal>Cerro Tres Picos</ogc:Literal>
          ...
          <ogc:Literal>Cerro Vallecitos</ogc:Literal>
                ...
                <!-- Etiquetas  - zoom 11 hacia abajo prioridad -->
                <!-- Etiquetas sin altura -->
                <se:Rule>
                    <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
                        <ogc:And>
...
<!-- Etiquetas con altura -->
               <se:Rule>
                ...
                <!-- Etiquetas Abra paso portillo portezuelo desde z14 -->
                <se:Rule>
                    <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
                        <ogc:PropertyIsEqualTo>
                            <ogc:PropertyName>entidad</ogc:PropertyName>
                    ...
                    <se:TextSymbolizer>
                        ...
                        <se:LabelPlacement>
                            <se:PointPlacement>
                                <se:AnchorPoint>
                                    <se:AnchorPointX>0.5</se:AnchorPointX>
                                    <se:AnchorPointY>1.3</se:AnchorPointY>
                                </se:AnchorPoint>
                            </se:PointPlacement>
                        </se:LabelPlacement>
                        <se:Halo>
                        ...
                        <se:Fill>
                            <se:SvgParameter name="fill">#66470a</se:SvgParameter>
                        </se:Fill>
                        <se:VendorOption name="autoWrap">50</se:VendorOption>
                        <se:VendorOption name="spaceAround">5</se:VendorOption>
                        <se:VendorOption name="charSpacing">0.3</se:VendorOption>
            ...
            <se:FeatureTypeStyle>
                <se:Rule>
                    <se:Name>Puntos Geomorfología</se:Name>
                    <se:Description>
                        <se:Title>Abra paso portillo portezuelo</se:Title> <!-- Desde z12-->
                    </se:Description>
                    <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
                        <ogc:PropertyIsEqualTo>
                            <ogc:PropertyName>entidad</ogc:PropertyName>
